...
const AdminSidebar = {
     ...
     */
    _injectStyles() {
        // Ensure the theme token sheet is present. Admin pages are wired here
        // (rather than per-page) — tokens must exist before eq-sidebar.css,
        // whose var(--eq-*) references resolve to nothing without them.
        if (!document.getElementById('eq-theme')) {
            ...
            theme.href = '/common/css/theme-' + themeName + '.css?v=1';
