...
| `social.js` | `social.html` | Timeline + Community tabs. Post composer, reactions. Feed: repost/quote dropdown, quoted post cards. Community: reply-with-quote, like on replies | 0, 1, 5, 6, 7 |
| `thread.js` | `thread.html` | Root post + chronological replies. Reply-to-reply (NIP-10 root+reply), repost/quote dropdown, quoted post cards, reaction UI on all replies | 0, 1, 6, 7 |
