/**
 * Centralized Session Management for Equaliser Client Pages
 *
 * Adapted from the admin session manager for client-side use.
 * Provides session storage with:
 * - Single login across all client pages
...
const SessionManager = {
     ...
     * Client pages redirect to /login.html (not /admin/login.html)
     */
