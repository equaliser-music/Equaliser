        ...
        _renderUser(npub, pubkeyHex) {
            ...
            mainContent.innerHTML = `
                ...
                <div class="user-follow-stats">
                    <span class="user-follow-stat eq-clickable" onclick="NostrSocial.showFollowListModal('${pubkeyHex}', 'following')"><strong id="user-following-count">0</strong> Following</span>
                    <span class="user-follow-stat eq-clickable" onclick="NostrSocial.showFollowListModal('${pubkeyHex}', 'followers')"><strong id="user-followers-count">0</strong> Followers</span>
                </div>
            ...
            container.innerHTML = notes.map(note => {
                ...
                return `
                    <div class="feed-item" data-note-id="${note.id}">
                        ...
                        <div class="feed-content eq-clickable" onclick="Router.navigate('/thread.html?id=${note.id}')">${content}</div>
